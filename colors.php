...
<body class="main">
    ...
    <div class="franse gray shadowin">
        <div class="row">
            <div class="col-sm-12">
                <h1>Colors by Default</h1>
                <h2>Colors are available for changes in scss/variables.scss</h2>
                <div class="row weiss">
                    <div class="col-sm-2 bg-black"> black </div>
                    <div class="col-sm-2 bg-yellow">yellow</div>
                    <div class="col-sm-2 bg-red">red</div>
                    <div class="col-sm-2 bg-blue">blue</div>
                    <div class="col-sm-2 bg-orange">orange</div>
                    <div class="col-sm-2 bg-violet">violet</div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row weiss">
                    <div class="col-sm-2 bg-green"> green </div>
                    <div class="col-sm-2 bg-pink">pink</div>
                    <div class="col-sm-2 bg-olive">olive</div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="row weiss">
                    <div class="col-sm-2 bg-white"> white </div>
                    <div class="col-sm-2 bg-gray-fb">gray-fb</div>
                    <div class="col-sm-2 bg-gray-f5">gray-f5</div>
                    <div class="col-sm-2 bg-gray-e6">gray-e6</div>
                    <div class="col-sm-2 bg-gray-9">gray-9</div>
                    <div class="col-sm-2 bg-gray-8">gray-8</div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="row weiss">
                    <div class="col-sm-2 bg-gray-7"> gray-7 </div>
                    <div class="col-sm-2 bg-gray-6">gray-6</div>
                    <div class="col-sm-2 bg-gray-5">gray-5</div>
                    <div class="col-sm-2 bg-gray-4">gray-4</div>
                    <div class="col-sm-2 bg-gray-3">gray-3</div>
                    <div class="col-sm-2 bg-gray-2">gray-2</div>
                </div>
            </div>
        </div>
    </div>

    <div class="franse gray">
        <div class="row">
            <div class="col-sm-12">
            <h1>Color List</h1>
            </div>
